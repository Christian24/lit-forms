...
const formConfig: Config<FormValues> = {
    ...
    validate: (values) => {
        const errors: { employees: any[] } = {employees: []};
        if (Array.isArray(values.employees)) {
    ...
    render() {
        ...
        return html`
            ...
            >
                ...
                ${array('employees', (item: Employee, register, getFieldState, index) => {
                            ...
                            return html`
                                <div>
                                    ...
                                    <md-filled-text-field
                                            ...
                                            .errorText=${getFieldState('firstName')?.error}
                                    ></md-filled-text-field>
                                </div>
                                <div>
                                    ...
                                    <md-filled-text-field
                                            ...
                                            ${register('lastName')}
                                            ?error=${getFieldState('lastName')?.touched && getFieldState('lastName')?.error}
                                            .errorText=${getFieldState('lastName')?.error}
                                    ></md-filled-text-field>
                                </div>
                                <div>
                                    ...
                                    <md-filled-select
                                            ${register('color')}
                                            ?error=${getFieldState('color')?.touched && getFieldState('color')?.error}
                                            .errorText=${getFieldState('color')?.error}
                                    >
